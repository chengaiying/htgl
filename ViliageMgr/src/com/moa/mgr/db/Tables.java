...
public class Tables {
	...
	public static class INSProd {
		...
		/** 邮箱地址 */
		public static final String COL_INSPROD_EMAIL = "email";
	...
	public static class INSApply {
		...
		/** 是否解决保险需求**/
		public static final String COL_SFJJBXXQ = "sfjjbxxq";
	...
	public static class TManager {
		...
		/** 如果是保险公司管理员，则该字段表示其有权限管理的保险公司 */
		public static final String COL_INSURER_ID = "insurer_id";
		/** 如果是地方管理员，表示对应的地域 */
