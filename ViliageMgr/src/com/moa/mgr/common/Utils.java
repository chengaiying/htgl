...
public class Utils {
	...
	//手机号码校验
    private static Pattern cellphonePattern = Pattern.compile("[1][4,3,5,7,8,6][0-9]{9}");
    /**
     * 判断是否为手机号
     * @param cellphone
     * @return
     ...
     * @return
     */
    public static boolean checkCellIdNumFormat(String idNum) {
        if (isEmpty(idNum)) {
            return false;
        }
